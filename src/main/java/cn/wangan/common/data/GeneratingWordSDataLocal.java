 ...
 * @author Mengfl
 */
public class GeneratingWordSDataLocal {
...
//    }
    ...
    public void generate500GData(File file) {
        generateNoSqlDataAndWriteToFile(1000000000000000000L, 534528, file, 5);
    }
...
//        String filePath = args[1];
        String  dataSize ="500G";
        String filePath="/Volumes/william/dataFile/word_count/500G/word2.txt";
        GeneratingWordSDataLocal generatingNoSqlData = new GeneratingWordSDataLocal();
